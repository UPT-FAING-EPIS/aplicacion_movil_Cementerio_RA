...
if (empty($existe) && $id_user != 1) {
    ...
    if (!empty($_POST)) {
        ...
        $alert = "";
        if (empty($codigo) || empty($producto) || empty($medida) || empty($precio) || $precio <  0 || empty($cantidad) || $cantidad < 0) {
            ...
            if ($result > 0) {
				...
				$query_insert = mysqli_query($conexion,"INSERT INTO producto(codigo,descripcion,medida,precio,existencia,usuario_id) values ('$codigo', '$producto','$medida','$precio','$cantidad','$usuario_id')");
                if ($query_insert) {
             ...
             <div class="modal-body">
                 <form action="" method="post" autocomplete="off">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" placeholder="Medida del producto" name="medida" id="medida" class="form-control">
                     </div>
                     <div class="form-group">
