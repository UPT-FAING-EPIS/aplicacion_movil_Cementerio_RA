...
INSERT INTO `configuracion` (`id`, `nombre`, `telefono`, `email`, `direccion`) VALUES
	(1, 'Tienda Deportiva OUT FIT TACNA', '925491523', 'info.tiendadeportoutfit@gmail.com', 'Tacna');
...
-- Dumping data for table sis_venta.detalle_permisos: ~7 rows (approximately)
...
-- Dumping data for table sis_venta.detalle_venta: ~7 rows (approximately)
...
-- Dumping data for table sis_venta.producto: ~15 rows (approximately)
...
-- Dumping data for table sis_venta.usuario: ~0 rows (approximately)
INSERT INTO `usuario` (`idusuario`, `nombre`, `correo`, `usuario`, `clave`, `estado`) VALUES
	...
	(2, 'Tell Casilla', 'tellcasilla2303@gmail.com', 'delivery', '21232f297a57a5a743894a0e4a801fc3', 1),
...
-- Dumping data for table sis_venta.ventas: ~0 rows (approximately)
